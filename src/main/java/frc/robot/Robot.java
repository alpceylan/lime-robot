...
public class Robot extends TimedRobot {
  ...
  public static NetworkTableInstance nt = NetworkTableInstance.create();
  ...
  NetworkTable limePlotter = nt.getTable("limePlotter");
  NetworkTableEntry estimated_x_position, estimated_y_position;
  ...
  public void autonomousPeriodic() {
    ...
    estimated_x_position.setDouble(robotPose.getTranslation().getX());
    estimated_y_position.setDouble(robotPose.getTranslation().getY());
  }
